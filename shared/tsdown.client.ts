/**
 * Repository-local tsdown preset for this standalone DSH UI plugin. It emits a
...
function clientConfig(id: string, entry: string): UserConfig {
  return {
    ...
    // tsdown auto-externalizes package dependencies; the deps policy above
    // keeps loader-table identities external and bundles everything else.
    plugins: [{
